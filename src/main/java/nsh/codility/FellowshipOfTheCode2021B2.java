...
public class FellowshipOfTheCode2021B2 implements FellowshipOfTheCode2021Interface {
	...
	public String solution(String S, int K) {
		...
		while (K > 0 && currentSeg < segCount) {
			...
			for (int i = currentSeg + 1; i < segCount && currentChar != globalMinChar && search <= K; i++) {
